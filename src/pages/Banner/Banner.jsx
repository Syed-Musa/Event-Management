...
const Banner = () => {
    return (
        <div className="w-[350px] md:w-[500px] lg:w-full h-[200px] lg:h-[600px] bg-cover bg-[url('https://i.ibb.co/42K4fMb/doctor-giving-presentation-team-interim-doctors.jpg')]">
